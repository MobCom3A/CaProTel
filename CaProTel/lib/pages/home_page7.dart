...
import 'package:caprotel/widg/home/hotel_search7.dart';
...
class Homey7Page extends StatefulWidget {
  const Homey7Page({Key? key}) : super(key: key);

  @override
  _Homey7PageState createState() => _Homey7PageState();
}

class _Homey7PageState extends State<Homey7Page> {
  @override
