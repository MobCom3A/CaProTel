...
import 'package:caprotel/widg/home/hotel_search8.dart';
...
class Homey8Page extends StatefulWidget {
  const Homey8Page({Key? key}) : super(key: key);

  @override
  _Homey8PageState createState() => _Homey8PageState();
}

class _Homey8PageState extends State<Homey8Page> {
  @override
